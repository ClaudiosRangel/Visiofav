  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        numeroDocumento: { type: 'string', description: 'Número da nota fiscal/fatura/documento lido (opcional)' },
        codigoBarras: { type: 'string', description: 'Linha digitável / código de barras do boleto ou conta de consumo (opcional)' },
      },

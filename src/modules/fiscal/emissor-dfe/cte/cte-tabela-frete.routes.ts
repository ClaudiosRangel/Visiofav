...
const tabelaFreteSchema = z.object({
  ...
  cMunOrigem: z.string().max(7).optional(),
  municipioOrigem: z.string().max(60).optional(),
  cMunDestino: z.string().max(7).optional(),
  municipioDestino: z.string().max(60).optional(),
  ...
  app.post('/cte/tabelas-frete', async (request, reply) => {
    ...
    const tabela = await prisma.tabelaFreteCte.create({
      data: {
        ...
        cMunOrigem: body.cMunOrigem,
        municipioOrigem: body.municipioOrigem,
        cMunDestino: body.cMunDestino,
        municipioDestino: body.municipioDestino,
